    ...
    <section class="relative border-b border-orange-50 bg-gradient-to-b from-[#FFFDF8] to-[#FFF6EB]">
      ...
      <div class="mx-auto max-w-4xl px-4 py-12 lg:py-20 sm:px-6 lg:px-8">
        ...
        <div class="space-y-12">
          <div
              v-for="(sectionKey, index) in faqSections"
              :key="sectionKey"
          ...
          >
            ...
            <div class="space-y-4">
              <details
                  v-for="(item, qIndex) in getQuestionsCount(sectionKey)"
                  :key="qIndex"
              ...
              >
                <summary
                  ...
                  <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-orange-50 text-[#FF6F3D] transition-transform duration-300 group-open:rotate-180 group-open:bg-[#FFE4D5]">
        ...
        <div class="mt-20 text-center opacity-0 translate-y-6 transition-all duration-700 delay-300 data-[inview=true]:opacity-100 data-[inview=true]:translate-y-0" data-reveal>
          <div class="inline-flex flex-col items-center rounded-3xl border border-orange-100 bg-white/60 p-8 shadow-sm">
            ...
            <p class="mt-2 text-slate-600 mb-6 max-w-sm">If you couldn't find the answer you were looking for, feel free to reach out directly.</p>
            <a class="inline-flex items-center justify-center rounded-full bg-slate-900 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-slate-800 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-900"
               href="mailto:moneykoi.app@gmail.com">
              Contact Support
            </a>
          </div>
        </div>
