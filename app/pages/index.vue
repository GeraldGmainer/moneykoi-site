  ...
  <main class="min-h-screen bg-[#FFFDF8] text-slate-900 overflow-x-clip">
      ...
      <div class="mx-auto max-w-screen-lg py-10 sm:py-14">
        <div class="grid gap-4 sm:gap-6 md:grid-cols-3">
          <div class="group rounded-3xl border border-orange-100 bg-white/80 p-5 sm:p-6 text-center shadow-sm shadow-orange-50/80 transition hover:-translate-y-1 hover:shadow-lg">
            ...
            <h3 class="text-base font-semibold text-slate-900">{{ $t('home.cards.offline.title') }}</h3>
            <p class="mt-2 text-sm leading-relaxed text-slate-600">{{ $t('home.cards.offline.desc') }}</p>
          </div>
          ...
          <div class="group rounded-3xl border border-orange-100 bg-white/80 p-5 sm:p-6 text-center shadow-sm shadow-orange-50/80 transition hover:-translate-y-1 hover:shadow-lg">
            ...
            <h3 class="text-base font-semibold text-slate-900">{{ $t('home.cards.focus.title') }}</h3>
            <p class="mt-2 text-sm leading-relaxed text-slate-600">{{ $t('home.cards.focus.desc') }}</p>
          </div>
          ...
          <div class="group rounded-3xl border border-orange-100 bg-white/80 p-5 sm:p-6 text-center shadow-sm shadow-orange-50/80 transition hover:-translate-y-1 hover:shadow-lg">
            ...
            <h3 class="text-base font-semibold text-slate-900">{{ $t('home.cards.design.title') }}</h3>
            <p class="mt-2 text-sm leading-relaxed text-slate-600">{{ $t('home.cards.design.desc') }}</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="px-4 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-screen-lg text-center">
        <p class="text-[11px] sm:text-xs font-semibold uppercase tracking-[0.25em] text-orange-400">{{ $t('home.designSection.pretitle') }}</p>
        <h2 class="mt-3 text-xl sm:text-2xl font-semibold tracking-tight text-slate-900">{{ $t('home.designSection.title') }}</h2>
        <p class="mx-auto mt-3 max-w-2xl text-sm sm:text-base leading-relaxed text-slate-600">
          {{ $t('home.designSection.desc') }}
        </p>
      </div>
    </section>
    ...
    <section id="warum" class="relative border-b border-orange-50 bg-gradient-to-b from-[#FFFDF8] to-[#FFF6EB]">
      ...
      <div class="mx-auto grid max-w-screen-lg items-center gap-8 sm:gap-10 px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)]">
        ...
        <div class="order-2 opacity-0 translate-y-4 transition-all duration-700 data-[inview=true]:opacity-100 data-[inview=true]:translate-y-0" data-reveal>
          <p class="text-[11px] sm:text-xs font-semibold uppercase tracking-[0.25em] text-orange-400">{{ $t('home.why.pretitle') }}</p>
          <h2 class="mt-2 text-xl sm:text-2xl font-semibold text-slate-900">{{ $t('home.why.title') }}</h2>
          ...
          <ul class="mt-5 space-y-3 text-sm text-slate-700 pl-5">
            <li class="list-disc">{{ $t('home.why.list1') }}</li>
            <li class="list-disc">{{ $t('home.why.list2') }}</li>
            <li class="list-disc">{{ $t('home.why.list3') }}</li>
          </ul>
    ...
    <section class="py-10 sm:py-12 px-4 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-screen-md text-center">
        <p class="text-xs font-semibold uppercase tracking-[0.25em] text-orange-400">{{ $t('home.cta.pretitle') }}</p>
